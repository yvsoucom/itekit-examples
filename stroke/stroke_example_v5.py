...
if __name__ == "__main__":
    ...
    # Configure IterKit
    # ------------------------------
    config.set_project("stroke_prediction_v5")
    ...
    config.set_prob_threshold_set([0.5,0.35,0.3,0.25,0.2,0.15,0.1])

    #config.set_random_state_set([126, 5012, 23])
    config.set_random_state_set([42,126, 5012])
    ...
    config.set_models(modelnames=["sklearn_SVM", "random_forest", "XGBmodel", "DTmodel", "LogisticRegression","GradientBoosting","XGBClassifier_SPW24", "BalancedRandomForest","EasyEnsemble"] )
