...
if __name__ == "__main__":
    ...
    # Configure IterKit
    # ------------------------------
    config.set_project("stroke_prediction_v6")
    ...
    config.set_models(modelnames=[ "random_forest", "XGBmodel",  "LogisticRegression","GradientBoosting","XGBClassifier_SPW24", "BalancedRandomForest","EasyEnsemble"] )
